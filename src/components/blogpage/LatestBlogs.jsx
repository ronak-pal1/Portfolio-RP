...
const LatestBlogs = ({ latestBlogs }) => {
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <p className="text-center text-3xl font-poppins mb-10 dark:text-white">
        Latest blogs
      </p>

      <div className="grid grid-cols-3 grid-rows-3 w-3/4 h-[900px] gap-3">
        <Link
        ...
        >
          <img
            ...
            alt="Blog Banner"
            className="h-4/6 w-full object-cover object-left-top rounded-t-md"
          />
          <div className="p-3 dark:text-white">
            <h1 className="text-base sm:text-3xl font-bold font-poppins">
              {latestBlogs[0]?.node.title}
            </h1>

            <p className="mt-2 font-extralight text-xs sm:text-lg line-clamp-3">
        ...
        {[1, 2, 3].map((value, index) => (
          ...
          >
            ...
            <div className="p-3 dark:text-white">
              ...
              <p className="mt-2 font-extralight text-xs sm:text-base line-clamp-2">
